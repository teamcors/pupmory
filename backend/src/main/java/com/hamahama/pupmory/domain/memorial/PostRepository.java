...
public interface PostRepository extends JpaRepository<Post, Long> {
    ...
    @Query("SELECT p FROM Post p WHERE p.userUid <> :userUid ORDER BY p.createdAt DESC")
    ...
    @Query(value = "SELECT *\n" +
            ...
            "WHERE post.user_uid != :userUid AND puppy_type = :puppyType\n" +
    ...
    @Query(value = "SELECT *\n" +
            ...
            "    INNER JOIN service_user\n" +
            "    ON post.user_uid = service_user.user_uid\n" +
            "WHERE post.user_uid != :userUid AND puppy_age = :puppyAge\n" +
            "ORDER BY created_at DESC;", nativeQuery = true)
    ...
    @Query(value = "SELECT *\n" +
            ...
            "    INNER JOIN service_user\n" +
            "    ON post.user_uid = service_user.user_uid\n" +
            "WHERE post.user_uid != :userUid AND puppy_type = :puppyType AND puppy_age = :puppyAge\n" +
            "ORDER BY created_at DESC;", nativeQuery = true)
